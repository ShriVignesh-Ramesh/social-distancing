...
const routes = [
    ...
    {
        path: 'user-name',
        loadChildren: () => __webpack_require__.e(/*! import() | user-name-user-name-module */ "user-name-user-name-module").then(__webpack_require__.bind(null, /*! ./user-name/user-name.module */ "./src/app/user-name/user-name.module.ts")).then(m => m.UserNameModule)
    },
    {
        path: 'survey',
    ...
    {
        path: 'questions',
        loadChildren: () => __webpack_require__.e(/*! import() | questions-questions-module */ "questions-questions-module").then(__webpack_require__.bind(null, /*! ./questions/questions.module */ "./src/app/questions/questions.module.ts")).then(m => m.QuestionsModule)
    },
    {
        path: 'result',
        loadChildren: () => __webpack_require__.e(/*! import() | result-result-module */ "result-result-module").then(__webpack_require__.bind(null, /*! ./result/result.module */ "./src/app/result/result.module.ts")).then(m => m.ResultModule)
    },
];
...
/* harmony import */ var _app_modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./app.modal */ "./src/app/app.modal.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, backgroundGeolocation, ringtones, appservice, backgroundMode, localNotifications) {
    ...
    initializeApp() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["interval"])(5000).subscribe(x => {
            ...
            this.objData = new _app_modal__WEBPACK_IMPORTED_MODULE_9__["Model"]();
            if (deviceId) {
                if (latVal && longVal && riskVal && protection) {
                    ...
                    this.appservice.sendPostRequest(this.objData).subscribe(res => {
                        console.log(res);
                        if (res) {
...
/* harmony import */ var _ionic_native_unique_device_id_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ionic-native/unique-device-id/ngx */ "./node_modules/@ionic-native/unique-device-id/ngx/index.js");
...
/* harmony import */ var _ionic_native_native_ringtones_ngx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ionic-native/native-ringtones/ngx */ "./node_modules/@ionic-native/native-ringtones/ngx/index.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _ionic_native_background_mode_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic-native/background-mode/ngx */ "./node_modules/@ionic-native/background-mode/ngx/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _ionic_native_unique_device_id_ngx__WEBPACK_IMPORTED_MODULE_9__["UniqueDeviceID"],
            ...
            _ionic_native_native_ringtones_ngx__WEBPACK_IMPORTED_MODULE_12__["NativeRingtones"],
...
let AppService = class AppService {
    ...
    postData(data) {
        ...
        return this.http
            .post('http://f60c8445.ngrok.io/coordinates', data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(error => this._handleError(error)));
    }
};
...
module.exports = __webpack_require__(/*! /Users/maha/social-distancing/src/main.ts */"./src/main.ts");
